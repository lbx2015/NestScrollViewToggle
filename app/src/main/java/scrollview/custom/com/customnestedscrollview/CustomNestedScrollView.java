...
/**
 * Created by JohnRambo on 2017/9/21
 * QQ:659316961
 */

public class CustomNestedScrollView extends FrameLayout implements NestedScrollingParent, ValueAnimator.AnimatorUpdateListener {

    public static final int MONTH = 100;
    public static final int WEEK = 200;
    private static int STATE = 100;//默认月
    private View weekCalendar;
    ...
    public CustomNestedScrollView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        duration = 240;
        monthHeigh = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,
                300, context.getResources().getDisplayMetrics());
        STATE = CustomNestedScrollView.MONTH;

        weekHeigh = monthHeigh / 5;
        monthCalendarOffset = monthHeigh - weekHeigh;
        ...
        monthCalendar.setBackground(getResources().getDrawable(android.R.color.holo_red_dark));
        weekCalendar.setBackground(getResources().getDrawable(android.R.color.holo_blue_bright));
        ...
        childViewValueAnimator.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                if (top == monthHeigh) {
                    ...
                    STATE = WEEK;
                    Log.d("zzw", "set week Calendar visible");
    ...
    private void move(int dy, boolean isNest, int[] consumed) {
        ...
        Log.d("zzw", "dy: " + dy + " monthCalendarTop: " + monthCalendarTop + " childViewTop: " + childViewTop + " monthCalendarOffset: " + monthCalendarOffset);
        //4种情况
